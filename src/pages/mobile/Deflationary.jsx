      ...
      <TokenDeployerMobileContainer>
        ...
        <SupplyContainer>
          <SupplyForm>
            ...
            <SupplyInputContainer>
              <label htmlFor="Symbol">Deflation:</label>
            ...
            >
              <p>
                Percentage set would be automatically burn on every transaction
              </p>
              <p
                style={{
                  fontSize: "14px",
              ...
              >
                Created tokens would be sent to your address by default.
              </p>
