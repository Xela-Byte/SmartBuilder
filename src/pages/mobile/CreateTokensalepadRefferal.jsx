...
import { CreateTokenRefferalContainer } from "../../styled/mobile/CreateTokensalepadRefferal";

const CreateTokensalepadRefferal = () => {
        ...
        <CreateTokenRefferalContainer>
          ...
          <CreateTokenForm>
            ...
            <CreateTokenInputContainer>
              ...
              <div>
                <input type="text" placeholder="0.0" style={{ width: "20%" }} />
                <p>%</p>
              </div>
            </CreateTokenInputContainer>{" "}
            <CreateTokenFeeOptionContainer>
...
export default CreateTokensalepadRefferal;
