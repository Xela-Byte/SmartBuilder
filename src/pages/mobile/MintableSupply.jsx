      ...
      <TokenDeployerMobileContainer>
        ...
        <SupplyContainer>
          <SupplyForm>
            ...
            <SupplyInputContainer>
              <label htmlFor="Initial Supply" className="supplyLabel">
                Initial Supply:
              </label>
              <input type="number" placeholder="Ex: 100000000000" />
            </SupplyInputContainer>
            <SupplyInputContainer>
              <label htmlFor="max Supply" className="supplyLabel">
                Max Supply:
              </label>
              <input type="number" placeholder="Ex: 100000000000" />
            </SupplyInputContainer>
            ...
            <SupplyFooter>
              <p>Created tokens would be sent to your address by default.</p>
              <p>Token Creation Cost : 10 NEAR</p>
            </SupplyFooter>
